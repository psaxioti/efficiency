...
typedef int (*f_function_type)(const gsl_vector *x, void *params,
                               gsl_vector *f);
typedef int (*df_function_type)(const gsl_vector *x, void *params,
                                gsl_matrix *J);
typedef int (*fdf_function_type)(const gsl_vector *x, void *params,
...
public:
  source();
  source(std::string, double, double, std::vector<double>, std::vector<double>,
...
public:
  ...
  fit_function();
  fit_function(std::string, std::string, int, double data[], f_function_type,
               df_function_type, fdf_function_type, normal_function,
               derivative_function);
  fit_function(std::string, std::string, int, double data[], normal_function,
               derivative_function);
};
